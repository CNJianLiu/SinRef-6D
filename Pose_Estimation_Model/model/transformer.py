...
class FSAM(nn.Module):
    ...
    def forward(self, x_1):
        ...
        # x_1 = x_1 + self.drop_path(self.attn_1(x_1)) 
        # x_1 = x_1 + self.drop_path(self.mlp(x_1)) 
...
class FCAM(nn.Module):
    ...
    def forward(self, x_1, x_2):
        ...
        # x = x_2 + self.drop_path(self.attn_1(x_1, x_2)) 
...
class DenseTransformer(nn.Module):
    ...
    def forward(self, dense_feats0, embeddings0, fps_idx0, dense_feats1, embeddings1, fps_idx1, masks0=None, masks1=None):
        ...
        # feats0 = self._sample_feats(dense_feats0, fps_idx0)
        # feats1 = self._sample_feats(dense_feats1, fps_idx1)
        feats0, feats1 = self.sparse_layer(dense_feats0, embeddings0, dense_feats1, embeddings1, masks0, masks1)
